...
public interface StaticGraph extends AutoCloseable {
    ...
    static Builder builder(final String name) {
        return new io.github.elevateddev.lattice.internal.graph.StaticGraphBuilder(name);
    }
    ...
    interface Builder {
        ...
        /**
         * Adds a multi-producer source that emits {@link io.github.elevateddev.lattice.routing.Stamped}
         * values.
         */
